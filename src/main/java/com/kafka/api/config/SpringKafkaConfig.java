...
public class SpringKafkaConfig {
	...
	public ConsumerFactory<String, Data> consumerFactory() {
		...
		configMap.put(JsonDeserializer.TRUSTED_PACKAGES, "com.kafka.api.model");
...
//line-50
	...
	public ConcurrentKafkaListenerContainerFactory<String, Data> kafkaListenerContainerFactory() {
		ConcurrentKafkaListenerContainerFactory<String, Data> factory = new ConcurrentKafkaListenerContainerFactory<String, Data>();
